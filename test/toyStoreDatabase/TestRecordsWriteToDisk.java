...
class TestRecordsWriteToDisk {
	...
	/**
	 * FIXME: this test needs to be busted up into a bunch of smaller test. This is
	 * ridiculous!
	...
	void testAddRecordAndSave() throws FileNotFoundException {
		...
		if (testToyList.size() < 1) {
			this.records
					.addRecord(new Animal("2000000001", "testAnimal", "cyberScientistToys", 9.99, 1, 1, "Fabric", "M"));
