...
public class Animal extends Toy {
	 ...
	 * @return the text description of the material (such as wood, or fabric) the animal is made from.
	 */
	 ...
	 * @param brand				The brand name (manufacturer) to associate with the animal.
	 ...
	 * @param material			A text description of the animal's fabrication material.
	 * @param size				The size of the animal.
	 */
	public Animal(String serialNumber, String name, String brand, double price, int availableCount, int appropriateAge, String material, String size) {
	 ...
	 * @param fields The record from the on-disk "database" to create an animal from.
	 */
	...
	/**A constructor used to create a place-holding animal, which avoids initializing the currentToy with null.
	 * 
	 */
	public Animal() {
		super();
	...
	public String toString() {
		return "Animal [getSerialNumber()=" + getSerialNumber() + ", getName()=" + getName() + ", getBrand()="
				+ getBrand() + ", getPrice()=" + getPrice() + ", getAvailableCount()=" + getAvailableCount()
				+ ", getAppropriateAge()=" + getAppropriateAge() + ", material=" + material + ", size=" + size + "]";
	}
