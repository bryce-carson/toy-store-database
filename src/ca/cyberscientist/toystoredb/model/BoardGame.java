...
public class BoardGame extends Toy {
	 ...
	 * @param brand				The brand name (manufacturer) to associate with the board game.
	 ...
	 * @param designer			The text description of the designer(s) of the board game.
	 */
	 ...
	 * @param fields The record from the on-disk "database" to create a board game from.
	 */
	...
	public String toString() {
		return "BoardGame [getSerialNumber()=" + getSerialNumber() + ", getName()=" + getName() + ", getBrand()="
				+ getBrand() + ", getPrice()=" + getPrice() + ", getAvailableCount()=" + getAvailableCount()
				+ ", getAppropriateAge()=" + getAppropriateAge() + ", minNumOfPlayers=" + minNumOfPlayers
				+ ", maxNumOfPlayers=" + maxNumOfPlayers + ", designer=" + designer + "]";
	}
